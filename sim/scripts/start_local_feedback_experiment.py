"""Stage-only launcher; all legacy launchers remain unchanged."""
import argparse
import json
...
def start(name, *, prepare_only=False, max_seconds=1800., reasoning='xhigh', input_dir=None, reference=None,
    ...
    service_args=[sys.executable,str(ROOT/'scripts/local_feedback_service.py'),'--reference',str(reference),'--socket-path',str(sock),
